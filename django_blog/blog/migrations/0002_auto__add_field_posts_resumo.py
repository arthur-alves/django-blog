...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posts.resumo'
        db.add_column(u'blog_posts', 'resumo',
                      self.gf('django.db.models.fields.TextField')(default=2, max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Posts.resumo'
        db.delete_column(u'blog_posts', 'resumo')
    ...
    models = {
        ...
        u'blog.posts': {
            ...
            'resumo': ('django.db.models.fields.TextField', [], {'max_length': '1000'}),
