...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posts.post_img'
        db.add_column(u'blog_posts', 'post_img',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Posts.post_img'
        db.delete_column(u'blog_posts', 'post_img')
    ...
    models = {
        ...
        u'blog.posts': {
            ...
            'post_img': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
